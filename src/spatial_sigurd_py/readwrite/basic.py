...
def _df_to_csc_sparse_v2(df: pd.DataFrame, dtype=np.float32) -> sp.csc_matrix:
    """Convert Dense or pandas-Sparse DataFrame (variantsxcells) to CSC (cellsxvariants) without densifying."""
...
def LoadingMAEGATK_typewise_visiumHD(
    ...
    *,
    ...
    alt_qual_global = _safe_div_sparse(alt_qsum, alt_reads)  # cellsxvars
